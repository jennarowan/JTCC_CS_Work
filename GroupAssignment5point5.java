...
public class GroupAssignment5point5 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // This strips out the two hyphens (provided they were entered in the correct places) and turns the remaining input into a numerical object, if possible
            int ssnJustNumbers = Integer.parseInt(ssn.substring(0,3) + ssn.substring(4,6) + ssn.substring(7));
            ...
            // Lastly we check to ensure the SSN is the proper number of digits and the hyphens are actually hyphens
